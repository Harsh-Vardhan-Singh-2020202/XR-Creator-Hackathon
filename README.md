Narada – AR Tourism & Spatial Experience Platform

An extended reality (XR) application built during the XR Creator Hackathon, designed to transform cultural tourism through interactive AR features, AI assistance, and spatial visualization.

* Frame2Ask: Scan cultural artifacts or images to render interactive 3D models and query details instantly using Gemini integration.
